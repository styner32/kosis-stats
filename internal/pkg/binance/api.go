...
func GetCryptoRSI(crypto string) (float64, error) {
	...
	// Security: Use a custom HTTP client with a timeout instead of the default http.Get
	// The default http.Get has no timeout and can lead to resource exhaustion / DoS.
	client := &http.Client{
